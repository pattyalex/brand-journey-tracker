...
- Match the tone and style of their existing content`;
  ...
  const dialogContent = (
    <div onClick={() => isMegAIOpen && setIsMegAIOpen(false)} className="flex flex-col h-full">
      ...
      <StepCompleteFooter stepNumber={2} completedSteps={completedSteps} onToggleComplete={onToggleComplete} showNextStep={!!onNavigateToStep} onNextStep={onNavigateToStep ? () => onNavigateToStep(3) : undefined} showPrevStep={!!onNavigateToStep} onPrevStep={onNavigateToStep ? () => onNavigateToStep(1) : undefined} />
    </div>
  );
