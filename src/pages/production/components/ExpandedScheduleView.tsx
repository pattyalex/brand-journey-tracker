    ...
    <div className="flex flex-col h-full overflow-hidden relative">
      ...
      {!planningMode && singleCard && isLeftPanelCollapsed && !singleCardScheduled && (
        <div className="flex items-center gap-4 px-4 py-3 border-b border-gray-100 flex-shrink-0">
          ...
          <div className="flex-1 flex justify-center">
            <ContentFlowProgress
              currentStep={5}
              onStepClick={onNavigateToStep ? (step) => { if (step !== 5) onNavigateToStep(step); } : undefined}
              className="w-[400px]"
      ...
      {!planningMode && singleCard && isLeftPanelCollapsed && singleCardScheduled && (
        <div className="flex items-center gap-4 px-4 py-3 border-b border-gray-100 flex-shrink-0">
          ...
          <div className="flex-1 flex justify-center">
            <ContentFlowProgress currentStep={5} onStepClick={onNavigateToStep ? (step) => { if (step !== 5) onNavigateToStep(step); } : undefined} className="w-[400px]" completedSteps={completedSteps} />
          </div>
          {onClose && (
