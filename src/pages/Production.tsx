...
const Production = () => {
  ...
  const getPlatformColors = (platform: string): { bg: string; text: string; hover: string } => {
    ...
    } else if (lowercased.includes('twitter') || lowercased.includes('x.com') || lowercased.includes('x /') || lowercased.includes('threads')) {
    ...
    // Default color (for Other/custom platforms)
...
Make each idea unique, creative, and directly tied to both the original content context and the user's specific twist.`;
            ...
            <div className="flex-1 overflow-y-auto px-6 pt-6 pb-6 space-y-6">
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-6 border border-indigo-100">
                <div className="space-y-4">
                  ...
                  <RadioGroup value={cardStatus || ''} onValueChange={(value) => setCardStatus(value as 'to-start' | 'needs-work' | 'ready')}>
                    {/* To Start */}
        ...
        {/* Ideate Card Editor Dialog */}
        <Dialog open={isIdeateCardEditorOpen} onOpenChange={(open) => {
          if (!open) {
            setIsIdeateCardEditorOpen(false);
            setEditingIdeateCard(null);
            setIdeateCardTitle("");
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="space-y-4">
              <input
                type="text"
                value={ideateCardTitle}
                onChange={(e) => setIdeateCardTitle(e.target.value)}
