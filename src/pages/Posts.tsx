...
const ListEmptyState: React.FC = () => (
  <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
    ...
    <h3 className="text-sm font-semibold text-gray-700 mb-1">No posts match these filters</h3>
    <p className="text-xs text-gray-400 max-w-xs leading-relaxed">Try adjusting your filters or add a new post below.</p>
  </div>
);
