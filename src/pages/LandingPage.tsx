...
const features = [
  {
    ...
    description: <><strong>Plan better. Post more consistently.</strong><br /><br />Keep your ideas in flow, not in folders. Enjoy a better organization system for your creative brain.</>,
    icon: FolderOpen,
  },
  {
