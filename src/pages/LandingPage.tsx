...
const features = [
  {
    ...
    description: <><strong>Plan smarter. Post consistently.</strong><br />Keep all your ideas, tasks, and content calendar in one place so you never get overwhelmed again.</>,
    icon: FolderOpen,
  },
  {
