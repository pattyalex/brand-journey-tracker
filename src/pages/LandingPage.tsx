...
import { RotateCw, Handshake, TrendingUp, CheckCircle } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 space-y-16 fade-in">
        ...
        <section className="py-10">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">Whether you're a creative, a founder, or just getting started - your content is your brand.</h2>
