      ...
      <div className="max-w-4xl mx-auto px-6 md:px-8 py-10 md:py-14">
        <div className="space-y-6">
          ...
          >
            ...
            <div className="space-y-4 text-[15px] leading-relaxed text-[#4d3e48]">
              <p>
                <strong>6.1 Cancellation.</strong> You may cancel your subscription at any time. Upon cancellation, you will retain access to the Service until the end of your current billing period. After your billing period ends, your account will be deactivated and you will no longer be able to access the Service. Your data will be retained until you explicitly request its deletion. You may resubscribe at any time to regain full access to your account and content. If you wish to have your data permanently deleted, you may do so by deleting your account from your account settings.
              </p>
              <p>
          ...
          >
            ...
            <div className="space-y-5 text-[15px] leading-relaxed text-[#4d3e48]">
              ...
              <div>
                ...
                <p>
                  You may export Your Content at any time while your account is active. If you cancel your membership, your account will remain active through the end of your current billing period, and you may export Your Content until that date. Once your billing period ends, your account will be deactivated, but Your Content will be retained until you explicitly request its deletion. You may resubscribe at any time to regain access to your account and all of Your Content. If you choose to delete your account at any time, all your data will be deleted immediately and permanently. We strongly recommend exporting your data before deleting your account, as this action cannot be undone.
                </p>
              </div>
            </div>
          </section>
