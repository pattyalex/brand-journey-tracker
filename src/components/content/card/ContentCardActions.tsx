        ...
        <TooltipProvider delayDuration={200}>
          <Tooltip>
            ...
            <TooltipContent 
              side="right" 
              align="center" 
              className="bg-white text-black border border-gray-200 px-4 py-2 text-sm font-medium z-[9999] shadow-lg rounded-md opacity-100 pointer-events-none relative top-2"
            >
