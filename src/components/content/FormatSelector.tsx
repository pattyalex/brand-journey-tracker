    ...
    <div className="space-y-2">
      ...
      {selectedFormat && (
        <div className="flex items-center mt-2">
          <span className="bg-orange-100 text-orange-800 text-sm px-3 py-1.5 rounded-full flex items-center gap-1.5">
            {selectedFormat}
            <Button 
              variant="ghost" 
              size="xs" 
              onClick={handleClearSelectedFormat}
              className="ml-1 p-0 h-5 w-5 rounded-full hover:bg-orange-200"
            >
