      ...
      <CardContent className="p-6">
        ...
        <div className="flex flex-wrap gap-6 justify-center sm:justify-start">
                    ...
                    <div className="relative group">
                      <Button
                        ...
                        className={`w-16 h-16 rounded-full mb-3 flex items-center justify-center ${
                          ...
                          isConnected ? "text-white shadow-md" : "text-gray-400"
                        } hover:scale-110 transition-all duration-200 border-0 p-0`}
                        onClick={() =>
                          isConnected
          ...
          <div className="flex flex-col items-center">
            <Button
              variant="outline"
              className="w-16 h-16 rounded-full mb-3 bg-gray-50 hover:bg-gray-100 hover:scale-110 transition-all duration-200 border-dashed border-2 border-gray-300 p-0"
