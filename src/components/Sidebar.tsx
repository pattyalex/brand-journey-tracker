...
import { Home, FolderOpen, FileText, Settings, ListTodo, Lightbulb, Trash2, Plus, CreditCard, Database, Workflow } from 'lucide-react';
...
const defaultMenuItems: MenuItem[] = [
  ...
  { title: 'Content Workflow', icon: Workflow, url: '/content-workflow', isDeletable: true },
